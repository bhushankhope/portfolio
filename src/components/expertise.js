                ...
                <div className='development-container'>
                    ...
                    <div className='bottom'>
                        <div className='description'>
                            Experienced in Python, Java, JavaScript, TypeScript, Spring Boot.
                        </div>
                    </div>
                </div>
                <div className='development-container'>
                    <div className='top'>
                        ...
                        <span className='expertise-label fr'>
                            Frontend Dev <br></br>
                            Angular, React
                        </span>
                    </div>
                    <div className='bottom'>
                        <div className='description'>
                            Passionate about Web Development. Over 1.5 years of development experience in HTML, CSS, JS, React and Angular frameworks.
                        </div>
                    </div>
                </div>
            </div>
